import{_ as i,c as a,a2 as n,o as l}from"./chunks/framework.DPuwY6B9.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"Backend/Git/git.md","filePath":"Backend/Git/git.md"}'),p={name:"Backend/Git/git.md"};function t(h,s,e,k,c,g){return l(),a("div",null,s[0]||(s[0]=[n(`<h2 id="新建代码库" tabindex="-1">新建代码库 <a class="header-anchor" href="#新建代码库" aria-label="Permalink to &quot;新建代码库&quot;">​</a></h2><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 在当前目录新建一个Git代码库</span></span>
